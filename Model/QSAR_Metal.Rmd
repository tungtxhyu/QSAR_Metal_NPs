...
```{r}
packages <- c("svDialogs", "data.table", "data.table", "openxlsx", "mlbench", "caret", "tools", "DT", "magrittr", "ggplot2", "nortest", "tseries", "stringr", "RcmdrMisc", "lmtest", "dplyr", "randomForest", "shiny", "shinydashboard")
...
```{r}
save(RFmodel, file = "www/RFmodel.RData")
```
